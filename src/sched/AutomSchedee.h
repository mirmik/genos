...
namespace Genos {
	...
	private:
		gxx::delegate<void, void*> routine;
		gxx::delegate<void, void*> destruct;
		void* local;
	public:
		AutomSchedee(gxx::delegate<void, void*> routine, void* local = nullptr,
				gxx::delegate<void, void*> destruct = do_nothing) :
	...
	private:
		gxx::delegate<void, int, char**> routine;
		str_argvc_t argvc;
