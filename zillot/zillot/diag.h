...
// Diag является отладочным интерфейсом ввода-вывода для таких систем, как
// debug_print, printk. Указанные системы используют функции, смонтированные в
//cdiag (current diag) Diag не регламинтирует, используется ли он для вывода в
// виде потока байт, консольного форматированного вывода, или вывода в файл. То
//есть cdiag является просто точкой монтирования функций ввода-вывода,
...
void diag_setup(const struct diag_ops *ndiag, void *priv);
