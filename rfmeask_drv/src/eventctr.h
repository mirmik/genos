...
public:
    ...
    void save_table(int saveno)
    {
        ...
        memcpy(saved_tables[saveno].prefix,
               cmdtable_prefix,
               saved_tables[saveno].prefix_size);
        memcpy(saved_tables[saveno].postfix,
               cmdtable_postfix,
               saved_tables[saveno].postfix_size);
        memcpy(saved_tables[saveno].cycle,
               cmdtable_cycle,
    ...
    void load_table(int saveno)
    {
        ...
        memcpy(cmdtable_prefix,
               saved_tables[saveno].prefix,
               saved_tables[saveno].prefix_size);
        memcpy(cmdtable_cycle,
               saved_tables[saveno].cycle,
               saved_tables[saveno].cycle_size);
        memcpy(cmdtable_postfix,
               saved_tables[saveno].postfix,
               saved_tables[saveno].postfix_size);
