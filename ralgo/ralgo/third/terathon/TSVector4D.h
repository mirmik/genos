...
namespace Terathon
{
    ...
    //# \ctor	template <typename type> explicit Vector4D(const Vec4D<type>&
    //v); # \ctor	Vector4D(const Vector3D& v, float d); # \ctor
    //Vector4D(const Vector3D& v); # \ctor	Vector4D(const Point3D& p); # \ctor
    //Vector4D(const Vector2D& v); # \ctor	Vector4D(const Point2D& p);
    //
    ...
    //# \param	v	(Template constructor) Another 4D vector, possibly with a
    //different component type, that is converted to a $Vector4D$.
    //# \param	v	A 3D vector whose entries are copied to the <i>x</i>,
    //<i>y</i>, and <i>z</i> coordinates. # \param	p	A 3D point whose entries
    //are copied to the <i>x</i>, <i>y</i>, and <i>z</i> coordinates.
    //
    //# \desc
    //# The $Vector4D$ class is used to store a four-dimensional vector
    //# having floating-point components <i>x</i>, <i>y</i>, <i>z</i>, and
    //<i>w</i>.
    //#
    //# The default constructor leaves the components of the vector undefined.
    //# If the values $a$, $b$, $c$, and $d$ are supplied, then they are
    //assigned to the # <i>x</i>, <i>y</i>, <i>z</i>, and <i>w</i> coordinates
    //of the vector, respectively. # If the $Vector4D$ object is constructed
    //using a $@Vector3D@$ or $@Vector2D@$ object, # then the <i>w</i>
    //coordinate is set to 0. If the $Vector4D$ object is constructed # using a
    //$@Point3D@$ or $@Point2D@$ object, then the <i>w</i> coordinate is set
    //to 1. # The <i>z</i> coordinate of a 2D vector or point is assumed to be
    //0.
    //
    //# \operator	float& operator [](machine k);
    //#				Returns a reference to the $k$-th scalar component of a
    //vector. #				The value of $k$ must be 0, 1, 2, or 3.
    //
    //# \operator	const float& operator [](machine k) const;
    //#				Returns a constant reference to the $k$-th scalar component of a
    //vector. #				The value of $k$ must be 0, 1, 2, or 3.
    //
    //# \operator	Vector4D& operator =(const Vector3D& v);
    //#				Copies the <i>x</i>, <i>y</i>, and <i>z</i> coordinates of $v$,
    //and assigns #				a value of 0 to the <i>w</i> coordinate.
    //
    //# \operator	Vector4D& operator =(const Point3D& p);
    //#				Copies the <i>x</i>, <i>y</i>, and <i>z</i> coordinates of $p$,
    //and assigns #				a value of 1 to the <i>w</i> coordinate.
    //
    //# \operator	Vector4D& operator =(const Vector2D& v);
    //#				Copies the <i>x</i> and <i>y</i> coordinates of $v$, assigns a
    //value of 0 to #				the <i>z</i> coordinate, and assigns a value
    //of 0 to the <i>w</i> coordinate.
    //
    //# \operator	Vector4D& operator =(const Point2D& p);
    //#				Copies the <i>x</i> and <i>y</i> coordinates of $p$, assigns a
    //value of 0 to #				the <i>z</i> coordinate, and assigns a value
    //of 1 to the <i>w</i> coordinate.
    //
    ...
    //const; #				Returns a boolean value indicating whether the two
    //vectors $v1$ and $v2$ are equal.
    //
    //# \action		bool operator !=(const Vector4D& v1, const Vector4D& v2)
    //const; #				Returns a boolean value indicating whether the two
    ...
    //#				Returns the sum of the vectors $a$ and $b$. The <i>w</i>
    //coordinate of $b$ is assumed to be 0.
    //
    //# \action		Vector4D operator +(const Vector3D& a, const Vector4D& b);
    //#				Returns the sum of the vectors $a$ and $b$. The <i>w</i>
    //coordinate of $a$ is assumed to be 0.
    //
    //# \action		Vector4D operator +(const Vector4D& a, const Vector2D& b);
    //#				Returns the sum of the vectors $a$ and $b$. The <i>z</i> and
    //<i>w</i> coordinates of $b$ are assumed to be 0.
    //
    //# \action		Vector4D operator +(const Vector2D& a, const Vector4D& b);
    //#				Returns the sum of the vectors $a$ and $b$. The <i>z</i> and
    //<i>w</i> coordinates of $a$ are assumed to be 0.
    //
    //# \action		Vector4D operator -(const Vector4D& a, const Vector4D& b);
    //#				Returns the difference of the vectors $a$ and $b$.
    //
    //# \action		Vector4D operator -(const Vector4D& a, const Vector3D& b);
    //#				Returns the difference of the vectors $a$ and $b$. The <i>w</i>
    //coordinate of $b$ is assumed to be 0.
    //
    //# \action		Vector4D operator -(const Vector3D& a, const Vector4D& b);
    //#				Returns the difference of the vectors $a$ and $b$. The <i>w</i>
    ...
    //
    //# \action		Vector4D operator -(const Vector4D& a, const Vector2D& b);
    //#				Returns the difference of the vectors $a$ and $b$. The <i>z</i>
    //and <i>w</i> coordinates of $b$ are assumed to be 0.
    //
    //# \action		Vector4D operator -(const Vector2D& a, const Vector4D& b);
    //#				Returns the difference of the vectors $a$ and $b$. The <i>z</i>
    //and <i>w</i> coordinates of $a$ are assumed to be 0.
    //
    ...
    //
    //# \action		Vector4D operator /(const Vector4D& v, float f);
    //#				Returns the product of the vector $v$ and the inverse of the
    //scalar $f$.
    //
    //# \action		Vector4D operator *(const Vector4D& a, const Vector4D& b);
    //#				Returns the componentwise product of the vectors $a$ and
    //$b$.
    //
    ...
    //#				Returns the 3D point represented by the vector $v$ after
    //unitization.
    //
    ...
    //#				Returns the four-dimensional dot product between $a$ and
    //$b$.
    //
    //# \action		float Dot(const Vector4D& a, const Vector3D& b);
    //#				Returns the dot product of the vectors $a$ and $b$. The <i>w</i>
    //coordinate of $b$ is assumed to be 0.
    //
    ...
    //#				Returns the dot product of the vector $v$ and the point $p$. The
    //<i>w</i> coordinate of $p$ is assumed to be 1.
    //
    //# \action		float Dot(const Point3D& p, const Vector4D& v);
    //#				Returns the dot product of the point $p$ and the vector $v$. The
    //<i>w</i> coordinate of $p$ is assumed to be 1.
    //
    //# \action		float Dot(const Vector4D& a, const Vector2D& b);
    //#				Returns the dot product with the vector $v$. The <i>z</i> and
    //<i>w</i> coordinates of $b$ are assumed to be 0.
    //
    //# \action		float Dot(const Vector2D& a, const Vector4D& b);
    //#				Returns the dot product of the vectors $a$ and $b$. The <i>z</i>
    //and <i>w</i> coordinates of $a$ is assumed to be 0.
    //
    //# \action		float Dot(const Vector4D& v, const Point2D& p);
    //#				Returns the dot product of the vector $v$ and the point $p$. The
    //<i>z</i> coordinate of $p$ is assumed to be 0, and the <i>w</i> coordinate
    //of $p$ is assumed to be 1.
    //
    ...
    //#				Returns (<b>a</b>&nbsp;&sdot;&nbsp;<b>b</b>)<b>b</b>, which is
    //the projection of $a$ onto $b$ under the assumption that the magnitude of
    //$b$ is one.
    //
    //# \action		Vector3D Reject(const Vector3D& a, const Vector3D& b);
    //#				Returns
    //(<b>a</b>&#x202F;&minus;&#x202F;<b>a</b>&nbsp;&sdot;&nbsp;<b>b</b>)<b>b</b>,
    //which is the rejection of $a$ from $b$ under the assumption that the
    //magnitude of $b$ is one.
    //
    //# \privbase	Vec4D	Vectors use a generic base class to store their
    //components.
    //
    //# \also	$@Trivector4D@$
    //# \also	$@Vector3D@$
    ...
    //# \param	v	A 3D vector whose entries are copied to the <i>x</i>,
    //<i>y</i>, and <i>z</i> coordinates.
    //
    //# \desc
    //# The $Set$ function sets the <i>x</i>, <i>y</i>, <i>z</i>, and <i>w</i>
    //coordinates of a vector to # the values given by the $a$, $b$, $c$, and
    ...
    //
    //# \desc
    //# The $Normalize$ function multiplies a 4D vector by the inverse of its
    //magnitude, # normalizing it to unit length. Normalizing the zero vector
    ...
    //
    //# \desc
    //# The $Unitize$ function multiplies a 4D vector by the inverse of its
    //<i>w</i> coordinate, # transforming it into a homogeneous point having a
    //unit weight. If the <i>w</i> coordinate is # zero, then the resulting
    //<i>x</i>, <i>y</i>, and <i>z</i> coordinates are undefined. # In all
    //cases, the <i>w</i> coordinate is 1.0 when this function returns.
    //#
    //# The return value is a reference to the vector object.

    //# \function	Vector4D::RotateAboutX		Rotates a vector about the <i>x</i>
    //axis.
    //
    //# \proto	Vector4D& RotateAboutX(float angle);
    //
    //# \param	angle	The angle through which the vector is rotated, in
    //radians.
    //
    //# \desc
    //# The $RotateAboutX$ function rotates a vector about the <i>x</i> axis
    //through the # angle given by the $angle$ parameter. The <i>w</i>
    //coordinate is not modified.
    //#
    //# The return value is a reference to the vector object.
    //
    ...
    //# \function	Vector4D::RotateAboutY		Rotates a vector about the <i>y</i>
    //axis.
    //
    ...
    //
    //# \desc
    //# The $RotateAboutY$ function rotates a vector about the <i>y</i> axis
    //through the # angle given by the $angle$ parameter. The <i>w</i>
    //coordinate is not modified.
    //#
    //# The return value is a reference to the vector object.
    ...
    //# \function	Vector4D::RotateAboutZ		Rotates a vector about the <i>z</i>
    //axis.
    //
    ...
    //
    //# \desc
    //# The $RotateAboutZ$ function rotates a vector about the <i>z</i> axis
    //through the # angle given by the $angle$ parameter. The <i>w</i>
    //coordinate is not modified.
    //#
    //# The return value is a reference to the vector object.
    ...
    //# \function	Vector4D::RotateAboutAxis		Rotates a vector about a given
    //axis.
    //
    //# \proto	Vector4D& RotateAboutAxis(float angle, const Bivector3D& axis);
    //
    //# \param	angle	The angle through which the vector is rotated, in
    //radians. # \param	axis	The axis about which the vector is rotated.
    //
    //# \desc
    //# The $RotateAboutAxis$ function rotates a vector through the angle given
    //by the # $angle$ parameter about the axis given by the $axis$ parameter.
    //The <i>w</i> coordinate is not modified.
    //#
    //# The return value is a reference to the vector object.
    //
    //# \also	$@Vector4D::RotateAboutX@$
    ...
    public:
        ...
        Vector4D(float a, float b, float c, float d)
            : Vec4D<TypeVector4D>(a, b, c, d)
        {
        }

        template <typename type>
        explicit Vector4D(const Vec4D<type> &v)
            : Vec4D<TypeVector4D>(
        ...
        template <typename type_struct,
                  ...
                  int index_z,
                  int index_w>
        Vector4D &operator=(const Subvec4D<type_struct,
                                           false,
                                           count,
                                           index_x,
                                           index_y,
        ...
        template <typename type> Vector4D &operator=(const Vec4D<type> &v)
        {
            x = float(v.x);
            y = float(v.y);
            z = float(v.z);
        ...
        TERATHON_API Vector4D &RotateAboutAxis(float angle,
