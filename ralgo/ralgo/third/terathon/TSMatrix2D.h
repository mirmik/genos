...
namespace Terathon
{
    ...
    //
    //# \desc
    //# The $Matrix2D$ class is used to store a 2&#x202F;&times;&#x202F;2
    ...
    //
    //# \privbase	Mat2D	Matrices use a generic base class to store their
    //components.
    //
    //# \also	$@Vector2D@$
    ...
    //
    //# \desc
    //# The $Set$ function sets all four entries of a matrix, either by
    //specifying each entry individually # or by specifying each of the two
    //columns as 2D vectors.
    //#
    ...
    //# \function	Matrix2D::SetIdentity		Sets a matrix to the
    ...
    //remaining column is orthogonalized and made unit length. Only the column
    //not specified # by the $column$ parameter can change direction.

    //# \function	Matrix2D::MakeRotation		Returns a matrix that represents a
    ...
    //through the angle given # by the $angle$ parameter in the 2D plane.
    //
    //# \also	$@Matrix2D::SetIdentity@$
    //# \also	$@Matrix2D::Set@$

    //# \function	Matrix2D::MakeScale		Returns a matrix that represents a
    //scale.
    //
    ...
    //along both axes. # If the $sx$ and $sy$ parameters are specified, then
    //they correspond to the scale along # the <i>x</i> and <i>y</i> axis,
    //respectively.
    //
    //# \also	$@Matrix2D::SetIdentity@$
    //# \also	$@Matrix2D::Set@$
    ...
    public:
        ...
        template <typename type_struct,
                  ...
                  int index_10,
                  int index_11>
        Matrix2D &operator=(const Submat2D<type_struct,
                                           count,
                                           index_00,
                                           index_01,
                                           index_10,
    ...
    inline typename type_struct::vector2D_type
    ...
    template <typename type_struct,
              ...
              int index_10,
              int index_11>
    inline Vector2D operator*(const Submat2D<type_struct,
                                             count,
                                             index_00,
                                             index_01,
                                             index_10,
    ...
    template <typename type_struct,
              ...
              int index_10,
              int index_11>
    inline Matrix2D operator*(const Matrix2D &m1,
                              const Submat2D<type_struct,
                                             count,
                                             index_00,
                                             index_01,
    ...
    template <typename type_struct,
              ...
              int index_10,
              int index_11>
    inline Matrix2D operator*(const Submat2D<type_struct,
                                             count,
                                             index_00,
                                             index_01,
                                             index_10,
