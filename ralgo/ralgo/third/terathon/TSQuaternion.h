...
namespace Terathon
{
    ...
    //
    //# \desc
    //# The $Quaternion$ class encapsulates a Hamiltonian quaternion having the
    //form #
    //<i>xi</i>&#x202F;+&#x202F;<i>yj</i>&#x202F;+&#x202F;<i>zk</i>&#x202F;+&#x202F;<i>w</i>.
    //#
    //# The default constructor leaves the components of the quaternion
    //undefined. # If the values $a$, $b$, $c$, and $s$ are supplied, then they
    //are assigned to the # <i>x</i>, <i>y</i>, <i>z</i>, and <i>w</i>
    //coordinates of the quaternion, respectively. # The components of $v$ are
    //assigned to the imaginary components <i>x</i>, <i>y</i>, and # <i>z</i> of
    //the quaternion, and the scalar $s$ is assigned to the real component
    //<i>w</i>. # If a quaternion is constructed with only the $@Vector3D@$
    //object $v$, then the real # coordinate <i>w</i> is set to 0. If a
    //quaternion is constructed with only the scalar $s$, # then the imaginary
    //components <i>x</i>, <i>y</i>, and <i>z</i> are set to 0.
    //#
    //# When performing arithmetic with quaternions, 3D vectors are always
    //treated as quaternions # with <i>w</i>&#x202F;=&#x202F;0, and scalars are
    //always treated as quaternions with #
    //<i>x</i>,<i>y</i>,<i>z</i>&#x202F;=&#x202F;0.
    //
    //# \operator	Quaternion& operator =(const Vector3D& v);
    //#				Assigns the of $v$ to the imaginary components <i>x</i>,
    //<i>y</i>, #				and <i>z</i> of the quaternion. The real
    //component <i>w</i> is set to 0.
    //
    //# \operator	Quaternion& operator =(float s);
    //#				Sets the real component <i>w</i> of the quaternion to $s$, and
    //sets the
    ...
    //
    //# \action		bool operator ==(const Quaternion& q1, const Quaternion&
    //q2);
    //#				Returns a boolean value indicating whether the two quaternions
    //$q1$ and $q2$ are equal.
    //
    //# \action		bool operator ==(const Quaternion& q, const Vector3D& v);
    //#				Returns a boolean value indicating whether the quaternion $q$ and
    //the vector $v$ are equal.
    //
    //# \action		bool operator ==(const Vector3D& v, const Quaternion& q);
    //#				Returns a boolean value indicating whether the vector $v$ and the
    //quaternion $q$ are equal.
    //
    //# \action		bool operator ==(const Quaternion& q, float s);
    //#				Returns a boolean value indicating whether the quaternion $q$ and
    //the scalar $s$ are equal.
    //
    //# \action		bool operator ==(float s, const Quaternion& q);
    //#				Returns a boolean value indicating whether the scalar $a$ and the
    //quaternion $q$ are equal.
    //
    //# \action		bool operator !=(const Quaternion& q1, const Quaternion&
    //q2);
    ...
    //# \action		bool operator !=(const Quaternion& q, const Vector3D& v);
    //#				Returns a boolean value indicating whether the quaternion $q$ and
    //the vector $v$ are not equal.
    //
    //# \action		bool operator !=(const Vector3D& v, const Quaternion& q);
    //#				Returns a boolean value indicating whether the vector $v$ and the
    //quaternion $q$ are not equal.
    //
    //# \action		bool operator !=(const Quaternion& q, float s);
    //#				Returns a boolean value indicating whether the quaternion $q$ and
    //the scalar $s$ are not equal.
    //
    //# \action		bool operator !=(float s, const Quaternion& q);
    //#				Returns a boolean value indicating whether the scalar $s$ and the
    //quaternion $q$ are not equal.
    //
    //# \action		Quaternion operator -(const Quaternion& q);
    //#				Returns the negation of the quaternion $q$.
    //
    //# \action		Quaternion operator +(const Quaternion& q1, const Quaternion&
    //q2); #				Returns the sum of the quaternions $q1$ and $q2$.
    //
    //# \action		Quaternion operator +(const Quaternion& q, const Vector3D&
    //v); #				Returns the sum of the quaternion $q$ and the vector
    //$v$.
    //
    //# \action		Quaternion operator +(const Vector3D& v, const Quaternion&
    //q); #				Returns the sum of the vector $v$ and the quaternion
    //$q$.
    //
    ...
    //
    //# \action		Quaternion operator -(const Quaternion& q1, const Quaternion&
    //q2); #				Returns the difference of the quaternions $q1$ and
    //$q2$.
    //
    //# \action		Quaternion operator -(const Quaternion& q, const Vector3D&
    //v);
    //#				Returns the difference of the quaternion $q$ and the vector
    //$v$.
    //
    //# \action		Quaternion operator -(const Vector3D& v, const Quaternion&
    //q);
    //#				Returns the difference of the vector $v$ and the quaternion
    //$q$.
    //
    //# \action		Quaternion operator -(const Quaternion& q, float s);
    //#				Returns the difference of the quaternion $q$ and the scalar
    //$s$.
    //
    //# \action		Quaternion operator -(float s, const Quaternion& q);
    //#				Returns the difference of the scalar $s$ and the quaternion
    //$q$.
    //
    //# \action		Quaternion operator *(const Quaternion& q1, const Quaternion&
    //q2); #				Returns the product of the quaternions $q1$ and
    //$q2$.
    //
    //# \action		Quaternion operator *(const Quaternion& q, const Vector3D&
    //v); #				Returns the product of the quaternion $q$ and the vector
    //$v$.
    //
    //# \action		Quaternion operator *(const Vector3D& v, const Quaternion&
    //q); #				Returns the product of the vector $v$ and the quaternion
    //$q$.
    //
    //# \action		Quaternion operator *(const Quaternion& q, float s);
    //#				Returns the product of the quaternion $q$ and the scalar
    //$s$.
    //
    //# \action		Quaternion operator *(float s, const Quaternion& q);
    //#				Returns the product of the scalar $s$ and the quaternion
    //$q$.
    //
    //# \action		Quaternion operator /(const Quaternion& q1, const Quaternion&
    //q2); #				Returns the quotient of the quaternions $q1$ and
    //$q2$.
    //
    //# \action		Quaternion operator /(const Quaternion& q, const Vector3D&
    //v);
    //#				Returns the quotient of the quaternion $q$ and of the vector
    //$v$.
    //
    //# \action		Quaternion operator /(const Vector3D& v, const Quaternion&
    //q);
    //#				Returns the quotient of the vector $v$ and the quaternion
    //$q$.
    //
    //# \action		Quaternion operator /(const Quaternion& q, float s);
    //#				Returns the quotient of the quaternion $q$ and the scalar
    //$s$.
    //
    //# \action		Quaternion operator /(float s, const Quaternion& q);
    //#				Returns the quotient of the scalar $s$ and the quaternion
    //$q$.
    //
    ...
    //# \function	Quaternion::Set		Sets all four components of a
    //quaternion.
    //
    ...
    //
    //# \desc
    //# The $Set$ function sets the <i>x</i>, <i>y</i>, <i>z</i>, and <i>w</i>
    //coordinates of # a quaternion to the values given by the $a$, $b$, $c$,
    //and $s$ parameters, respectively. # If the parameters $v$ and $s$ are
    //supplied, then the <i>x</i>, <i>y</i>, and <i>z</i> # coordinates are set
    //to those of the vector $v$, and the <i>w</i> coordinate is set to # the
    //value given by $s$.
    //#
    ...
    //
    //# \desc
    //# The $Normalize$ function multiplies a quaternion by the inverse of its
    //magnitude, # normalizing it to unit length. Normalizing the zero
    //quaternion produces undefined results.
    //#
    //# The return value is a reference to the quaternion object.

    //# \function	Quaternion::MakeRotationX		Returns a quaternion that
    ...
    //
    //# \desc
    //# The $MakeRotationX$ function returns a quaternion representing the
    //rotation through the angle given # by the $angle$ parameter about the
    //<i>x</i> axis. The resulting quaternion has unit length.
    //
    ...
    //# \function	Quaternion::MakeRotationY		Returns a quaternion that
    ...
    //
    //# \desc
    //# The $MakeRotationY$ function returns a quaternion representing the
    //rotation through the angle given # by the $angle$ parameter about the
    //<i>y</i> axis. The resulting quaternion has unit length.
    //
    ...
    //# \function	Quaternion::MakeRotationZ		Returns a quaternion that
    ...
    //
    //# \desc
    //# The $MakeRotationZ$ function returns a quaternion representing the
    //rotation through the angle given # by the $angle$ parameter about the
    //<i>z</i> axis. The resulting quaternion has unit length.
    //
    //# \also	$@Quaternion::MakeRotationX@$
    //# \also	$@Quaternion::MakeRotationY@$
    //# \also	$@Quaternion::MakeRotation@$
    ...
    //# \function	Quaternion::MakeRotation		Returns a quaternion that
    //represents a rotation about a given axis.
    //
    //# \proto	static Quaternion MakeRotation(float angle, const Bivector3D&
    //axis);
    //
    //# \param	angle	The angle of rotation, in radians.
    ...
    //
    //# \desc
    //# The $MakeRotation$ function returns a quaternion representing a rotation
    //through the angle # given by the $angle$ parameter about the axis given by
    //the $axis$ parameter. The resulting # quaternion has unit length.
    //
    //# \also	$@Quaternion::MakeRotationX@$
    //# \also	$@Quaternion::MakeRotationY@$
    //# \also	$@Quaternion::MakeRotationZ@$
    ...
    //# \function	Quaternion::GetRotationMatrix		Converts a quaternion to a
    //3&#x202F;&times;&#x202F;3 matrix.
    //
    //# \proto	Matrix3D GetRotationMatrix(void) const;
    //
    //# \desc
    //# The $GetRotationMatrix$ function converts a unit quaternion to a
    //$@Matrix3D@$ object that # represents the same rotation when it
    //premultiplies a $@Vector3D@$ object.
    //
    ...
    //# \function	Quaternion::SetRotationMatrix		Converts a
    //3&#x202F;&times;&#x202F;3 matrix to a quaternion.
    //
    ...
    //
    //# \desc
    //# The $SetRotationMatrix$ function sets the components of a quaternion to
    //values that # represent the same rotation as the one represented by the
    //matrix specified by the $M$ parameter.
    //#
    ...
    public:
        ...
        {
            return (Vector3D(1.0F - 2.0F * (y * y + z * z),
                             2.0F * (x * y + w * z),
                             2.0F * (x * z - w * y)));
        }
    ...
    TERATHON_API Quaternion operator*(const Quaternion &q1,
                                      const Quaternion &q2);
