...
namespace Terathon
{
    ...
    inline float Fmin(const float &x, const float &y, const float &z)
    {
        ...
        VecStoreX(
            VecMinScalar(VecMinScalar(VecLoadScalar(&x), VecLoadScalar(&y)),
                         VecLoadScalar(&z)),
            &result);
        return (result);
    ...
    inline float
    Fmin(const float &x, const float &y, const float &z, const float &w)
    {
#ifndef TERATHON_NO_SIMD
        ...
        VecStoreX(
            VecMinScalar(VecMinScalar(VecLoadScalar(&x), VecLoadScalar(&y)),
                         VecMinScalar(VecLoadScalar(&z), VecLoadScalar(&w))),
            &result);
        return (result);
    ...
    inline float Fmax(const float &x, const float &y, const float &z)
    {
        ...
        VecStoreX(
            VecMaxScalar(VecMaxScalar(VecLoadScalar(&x), VecLoadScalar(&y)),
                         VecLoadScalar(&z)),
            &result);
        return (result);
    ...
    inline float
    Fmax(const float &x, const float &y, const float &z, const float &w)
    {
#ifndef TERATHON_NO_SIMD
        ...
        VecStoreX(
            VecMaxScalar(VecMaxScalar(VecLoadScalar(&x), VecLoadScalar(&y)),
                         VecMaxScalar(VecLoadScalar(&z), VecLoadScalar(&w))),
            &result);
        return (result);
    ...
    inline float Saturate(const float &x)
    {
        ...
        VecStoreX(
            VecMinScalar(VecMaxScalar(VecLoadScalar(&x), VecFloatGetZero()),
                         VecLoadVectorConstant<0x3F800000>()),
            &result);
        return (result);
    ...
    inline float Clamp(const float &x, const float &y, const float &z)
    {
        ...
        VecStoreX(
            VecMinScalar(VecMaxScalar(VecLoadScalar(&x), VecLoadScalar(&y)),
                         VecLoadScalar(&z)),
            &result);
        return (result);
