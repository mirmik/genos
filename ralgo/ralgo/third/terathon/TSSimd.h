...
#define _MM_SHUFFLE(p3, p2, p1, p0)                                            \
    (((p3) << 6) | ((p2) << 4) | ((p1) << 2) | (p0))
...
namespace Terathon
{
    struct vec_float
    {
        ...
        vec_float(float32x4_t m)
        {
            v = m;
        }

        operator float32x4_t &(void)
        {
            return (v);
        }
        operator const float32x4_t &(void) const
        {
            return (v);
        }
    ...
    struct exv_float
    {
        ...
        operator __m256 &(void)
        {
            return (v);
        }
        operator const __m256 &(void) const
        {
            return (v);
        }
    ...
    inline vec_float VecFloatGetMinusZero(void)
    {
        ...
        alignas(16) static const uint32 float_80000000[4] = {
    ...
    template <uint32 value> inline vec_float VecLoadVectorConstant(void)
    {
#if defined(TERATHON_SSE)
    ...
    template <uint32 value> inline vec_float VecLoadScalarConstant(void)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float
    VecMadd(const vec_float &v1, const vec_float &v2, const vec_float &v3)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float
    VecMaddScalar(const vec_float &v1, const vec_float &v2, const vec_float &v3)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float
    VecNmsub(const vec_float &v1, const vec_float &v2, const vec_float &v3)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float VecNmsubScalar(const vec_float &v1,
                                    const vec_float &v2,
                                    const vec_float &v3)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float
    VecSelect(const vec_float &v1, const vec_float &v2, const vec_float &mask)
    {
#if defined(TERATHON_SSE)
    ...
    inline bool VecCmpltAny3D(const vec_float &v1, const vec_float &v2)
    {
        ...
        return ((_mm_comilt_ss(v1, v2) |
                 _mm_comilt_ss(VecSmearY(v1), VecSmearY(v2)) |
                 _mm_comilt_ss(VecSmearZ(v1), VecSmearZ(v2))) != 0);

#elif defined(TERATHON_NEON)

        return ((vgetq_lane_f32(v1, 0) < vgetq_lane_f32(v2, 0)) ||
                (vgetq_lane_f32(v1, 1) < vgetq_lane_f32(v2, 1)) ||
                (vgetq_lane_f32(v1, 2) < vgetq_lane_f32(v2, 2)));
    ...
    inline bool VecCmpgtAny3D(const vec_float &v1, const vec_float &v2)
    {
        ...
        return ((_mm_comigt_ss(v1, v2) |
                 _mm_comigt_ss(VecSmearY(v1), VecSmearY(v2)) |
                 _mm_comigt_ss(VecSmearZ(v1), VecSmearZ(v2))) != 0);
    ...
    inline vec_float VecInverseSqrt(const vec_float &v)
    {
        ...
        return (_mm_mul_ps(
            _mm_mul_ps(_mm_sub_ps(three, _mm_mul_ps(v, _mm_mul_ps(f, f))), f),
            half));
    ...
    inline vec_float VecInverseSqrtScalar(const vec_float &v)
    {
        ...
        return (_mm_mul_ss(
            _mm_mul_ss(_mm_sub_ss(three, _mm_mul_ss(v, _mm_mul_ss(f, f))), f),
            half));
    ...
    inline vec_float VecFloor(const vec_float &v)
    {
        ...
        vec_float result = _mm_sub_ps(
            _mm_add_ps(_mm_add_ps(_mm_sub_ps(v, two23), two23), two23), two23);
        result = _mm_sub_ps(result, _mm_and_ps(one, _mm_cmplt_ps(v, result)));

        vec_float mask =
            _mm_cmplt_ps(two23, _mm_andnot_ps(VecFloatGetMinusZero(), v));
        ...
        vec_float result = vsubq_f32(
            vaddq_f32(vaddq_f32(vsubq_f32(v, two23), two23), two23), two23);
        result = vsubq_f32(
            result,
            vreinterpretq_f32_u32(vandq_u32(one, vcltq_f32(v, result))));
    ...
    inline vec_float VecFloorScalar(const vec_float &v)
    {
        ...
        vec_float result = _mm_sub_ss(
            _mm_add_ss(_mm_add_ss(_mm_sub_ss(v, two23), two23), two23), two23);
    ...
    inline vec_float VecCeil(const vec_float &v)
    {
        ...
        result = vaddq_f32(
            result,
            vreinterpretq_f32_u32(vandq_u32(one, vcltq_f32(result, v))));
    ...
    inline void
    VecFloorCeilScalar(const vec_float &v, vec_float *f, vec_float *c)
    {
#if defined(TERATHON_SSE)
    ...
    inline void
    VecPositiveFloorCeil(const vec_float &v, vec_float *f, vec_float *c)
    {
#if defined(TERATHON_SSE)
    ...
    inline void
    VecPositiveFloorCeilScalar(const vec_float &v, vec_float *f, vec_float *c)
    {
#if defined(TERATHON_SSE)
    ...
    inline void
    VecNegativeFloorCeil(const vec_float &v, vec_float *f, vec_float *c)
    {
#if defined(TERATHON_SSE)
    ...
    inline void
    VecNegativeFloorCeilScalar(const vec_float &v, vec_float *f, vec_float *c)
    {
#if defined(TERATHON_SSE)
    ...
    inline vec_float VecDot4D(const vec_float &v1, const vec_float &v2)
    {
        ...
        vec_float d = _mm_mul_ps(v1, v2);
        return (
            _mm_add_ss(_mm_add_ss(_mm_add_ss(d, VecSmearY(d)), VecSmearZ(d)),
                       VecSmearW(d)));
        ...
        vec_float d = vmulq_f32(v1, v2);
        return (vaddq_f32(
            vaddq_f32(vpaddq_f32(d, d), vdupq_n_f32(vgetq_lane_f32(d, 2))),
            vdupq_n_f32(vgetq_lane_f32(d, 3))));

#endif
    }

    inline vec_float VecPlaneDotPoint3D(const vec_float &v1,
                                        const vec_float &v2)
    {
#if defined(TERATHON_SSE)
        ...
        return (vaddq_f32(
            vaddq_f32(vpaddq_f32(d, d), vdupq_n_f32(vgetq_lane_f32(d, 2))),
            vdupq_n_f32(vgetq_lane_f32(v1, 3))));
    ...
    inline vec_float VecReject3D(const vec_float &v1, const vec_float &v2)
    {
        ...
        vec_float d = VecDot3D(v1, v2);
        return (
            vsubq_f32(v1, vmulq_f32(v2, vdupq_n_f32(vgetq_lane_f32(d, 0)))));
    ...
    inline vec_float VecCross3D(const vec_float &v1, const vec_float &v2)
    {
        ...
        c = _mm_sub_ps(
            c, _mm_mul_ps(_mm_shuffle_ps(v1, v1, _MM_SHUFFLE(3, 0, 2, 1)), v2));
    ...
    inline vec_float VecTransformVector3D(const vec_float &c1,
                                          const vec_float &c2,
                                          const vec_float &c3,
                                          const vec_float &v)
    {
    ...
    inline vec_float VecTransformPoint3D(const vec_float &c1,
                                         const vec_float &c2,
                                         const vec_float &c3,
                                         const vec_float &c4,
                                         const vec_float &p)
    ...
    inline vec_int8 VecInt8GetInfinity(void)
    {
        ...
        alignas(16) static const uint8 int_80[16] = {0x80,
                                                     0x80,
                                                     0x80,
                                                     0x80,
                                                     0x80,
    ...
    inline vec_int16 VecInt32PackSaturate(const vec_int32 &v1,
                                          const vec_int32 &v2)
    {
#if defined(TERATHON_SSE)
    ...
    {
        alignas(32) static const uint32 float_80000000[8] = {0x80000000,
                                                             0x80000000,
                                                             0x80000000,
                                                             0x80000000,
                                                             0x80000000,
                                                             ...
                                                             0x80000000};
        return (
            _mm256_load_ps(reinterpret_cast<const float *>(float_80000000)));
    }
    ...
    inline exv_float
    ExvMadd(const exv_float &v1, const exv_float &v2, const exv_float &v3)
    {
