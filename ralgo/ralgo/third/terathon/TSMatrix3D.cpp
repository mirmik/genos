...
const ConstMatrix3D Matrix3D::identity = {
...
Matrix3D::Matrix3D(float n00,
                   ...
                   float n21,
                   float n22)
    : Mat3D<TypeMatrix3D>(n00, n01, n02, n10, n11, n12, n20, n21, n22)
{
}
...
Matrix3D &Matrix3D::Set(float n00,
                        float n01,
                        float n02,
                        float n10,
                        float n11,
...
Matrix3D Matrix3D::MakeRotationX(float angle)
{
    ...
    return (Matrix3D(1.0F, 0.0F, 0.0F, 0.0F, v.x, -v.y, 0.0F, v.y, v.x));
}
...
Matrix3D Matrix3D::MakeRotationY(float angle)
{
    ...
    return (Matrix3D(v.x, 0.0F, v.y, 0.0F, 1.0F, 0.0F, -v.y, 0.0F, v.x));
}
...
Matrix3D Matrix3D::MakeRotationZ(float angle)
{
    ...
    return (Matrix3D(v.x, -v.y, 0.0F, v.y, v.x, 0.0F, 0.0F, 0.0F, 1.0F));
}
