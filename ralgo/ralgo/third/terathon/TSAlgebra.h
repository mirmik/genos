...
namespace Terathon
{
    template <typename type_struct, int count, int index> class Component
    {
    public:
    ...
    template <int count,
              ...
              int A_index_x,
              typename B_type_struct,
              int B_index_x>
    inline bool operator==(const Component<A_type_struct, count, A_index_x> &A,
                           const Component<B_type_struct, count, B_index_x> &B)
    {
    ...
    template <typename type_struct> struct ConverterVector2D<type_struct, 0, 1>
    {
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector2D_type &vector2D_type;
    ...
    template <typename type_struct> struct ConverterVector2D<type_struct, 1, 2>
    {
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector2D_type &vector2D_type;
        typedef const typename type_struct::vector2D_type &const_vector2D_type;
    ...
    template <typename type_struct> struct ConverterVector2D<type_struct, 2, 3>
    {
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector2D_type &vector2D_type;
        typedef const typename type_struct::vector2D_type &const_vector2D_type;
    ...
    public:
        ...
        operator typename ConverterVector2D<type_struct, index_x, index_y>::
            vector2D_type(void)
        {
            return (ConverterVector2D<type_struct, index_x, index_y>::Convert(
                data));
        }

        operator typename ConverterVector2D<type_struct, index_x, index_y>::
            const_vector2D_type(void) const
        {
            return (ConverterVector2D<type_struct, index_x, index_y>::Convert(
                data));
        }
        ...
        {
            return (*this *= InverseSqrt(data[index_x] * data[index_x] +
                                         data[index_y] * data[index_y]));
        }
    };
    ...
    template <typename A_type_struct,
              ...
              int B_index_y>
    inline bool
    operator==(const Subvec2D<A_type_struct, A_count, A_index_x, A_index_y> &A,
               const Subvec2D<B_type_struct, B_count, B_index_x, B_index_y> &B)
    {
        return ((A.data[A_index_x] == B.data[B_index_x]) &&
                (A.data[A_index_y] == B.data[B_index_y]));
    }
    ...
    public:
        ...
        Subvec3D &Set(const component_type &x,
        ...
        operator typename ConverterVector3D<type_struct,
                                            index_x,
                                            index_y,
                                            index_z>::vector3D_type(void)
        {
            return (ConverterVector3D<type_struct, index_x, index_y, index_z>::
                        Convert(data));
        }
        ...
        operator typename ConverterVector3D<type_struct,
                                            index_x,
                                            index_y,
                                            index_z>::const_vector3D_type(void)
            const
        {
            return (ConverterVector3D<type_struct, index_x, index_y, index_z>::
                        Convert(data));
        ...
        Subvec3D &
        operator=(const Subvec3D<type, anti, cnt, ind_x, ind_y, ind_z> &value)
        {
            data[index_x] = value.data[ind_x];
            data[index_y] = value.data[ind_y];
        ...
        {
            return (*this *= InverseSqrt(float(data[index_x] * data[index_x] +
                                               data[index_y] * data[index_y] +
                                               data[index_z] * data[index_z])));
        }
    };
    ...
    template <typename A_type_struct,
              ...
              int B_index_y,
              int B_index_z>
    inline bool operator==(const Subvec3D<A_type_struct,
                                          A_anti,
                                          A_count,
                                          A_index_x,
                                          A_index_y,
                                          A_index_z> &A,
                           const Subvec3D<B_type_struct,
                                          B_anti,
                                          B_count,
                                          B_index_x,
                                          B_index_y,
                                          B_index_z> &B)
    {
        return ((A.data[A_index_x] == B.data[B_index_x]) &&
                (A.data[A_index_y] == B.data[B_index_y]) &&
                (A.data[A_index_z] == B.data[B_index_z]));
    }
    ...
    struct ConverterVector4D
    {
        ...
        {
            return (vector4D_type(
                data[index_x], data[index_y], data[index_z], data[index_w]));
        }

        static const_vector4D_type Convert(const component_type *data)
        {
            return (const_vector4D_type(
                data[index_x], data[index_y], data[index_z], data[index_w]));
        }
    };
    ...
    public:
        ...
        Subvec4D &Set(const component_type &x,
                      const component_type &y,
                      const component_type &z,
                      const component_type &w)
        {
            data[index_x] = x;
            data[index_y] = y;
            data[index_z] = z;
        ...
        operator typename ConverterVector4D<type_struct,
                                            index_x,
                                            index_y,
                                            index_z,
                                            index_w>::vector4D_type(void)
        {
            return (ConverterVector4D<type_struct,
                                      index_x,
                                      index_y,
                                      index_z,
                                      index_w>::Convert(data));
        }
        ...
        operator typename ConverterVector4D<type_struct,
                                            ...
                                            index_y,
                                            index_z,
                                            index_w>::const_vector4D_type(void)
            const
        {
            return (ConverterVector4D<type_struct,
                                      index_x,
        ...
        template <typename type,
                  ...
                  int ind_w>
        Subvec4D &operator=(
            const Subvec4D<type, anti, cnt, ind_x, ind_y, ind_z, ind_w> &value)
        {
            data[index_x] = value.data[ind_x];
            data[index_y] = value.data[ind_y];
            data[index_z] = value.data[ind_z];
    ...
    template <typename A_type_struct,
              ...
              int B_index_z,
              int B_index_w>
    inline bool operator==(const Subvec4D<A_type_struct,
                                          A_anti,
                                          A_count,
                                          A_index_x,
                                          A_index_y,
                                          ...
                                          B_index_w> &B)
    {
        return ((A.data[A_index_x] == B.data[B_index_x]) &&
                (A.data[A_index_y] == B.data[B_index_y]) &&
                (A.data[A_index_z] == B.data[B_index_z]) &&
                (A.data[A_index_w] == B.data[B_index_w]));
    }
    ...
    template <typename type_struct> class Vec2D
    {
    public:
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector2D_type vector2D_type;
    ...
    template <typename type_struct>
    inline bool operator==(const Vec2D<type_struct> &v1,
                           const Vec2D<type_struct> &v2)
    {
        return (v1.xy == v2.xy);
    }
    ...
    template <typename type_struct, bool anti = false> class Vec3D
    {
    public:
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector3D_type vector3D_type;
    ...
    protected:
        ...
        Vec3D(const component_type &a,
              const component_type &b,
    ...
    public:
        ...
        template <typename type, int cnt, int ind_x, int ind_y, int ind_z>
        Vec3D &
        operator=(const Subvec3D<type, anti, cnt, ind_x, ind_y, ind_z> &v)
        {
            xyz = v;
            return (*this);
        }
    ...
    inline bool operator==(const Vec3D<type_struct, anti> &v1,
                           const Vec3D<type_struct, anti> &v2)
    {
    ...
    template <typename type_struct, bool anti = false> class Vec4D
    {
    public:
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::vector4D_type vector4D_type;
    ...
    protected:
        ...
        Vec4D(const component_type &a,
              const component_type &b,
              const component_type &c,
              const component_type &d)
        {
            x = a;
            y = b;
            z = c;
    ...
    public:
        ...
        template <typename type,
                  ...
                  int ind_w>
        Vec4D &operator=(
            const Subvec4D<type, anti, cnt, ind_x, ind_y, ind_z, ind_w> &v)
        {
            xyzw = v;
            return (*this);
        }
    ...
    template <typename type_struct, bool anti>
    inline bool operator==(const Vec4D<type_struct, anti> &v1,
                           const Vec4D<type_struct, anti> &v2)
    {
    ...
    template <typename A_type_struct,
              ...
              int B_index_y,
              int B_index_z>
    inline float operator^(const Subvec3D<A_type_struct,
                                          A_anti,
                                          A_count,
                                          A_index_x,
                                          A_index_y,
    ...
    template <typename A_type_struct,
              ...
              int B_index_z,
              int B_index_w>
    inline float operator^(const Subvec4D<A_type_struct,
                                          A_anti,
                                          A_count,
                                          A_index_x,
                                          A_index_y,
    ...
    struct ConverterMatrix2D
    {
        ...
        {
            return (matrix2D_type(data[index_00],
                                  data[index_01],
                                  data[index_10],
                                  data[index_11]));
        }
        ...
        {
            return (const_matrix2D_type(data[index_00],
                                        data[index_01],
                                        data[index_10],
                                        data[index_11]));
        }
    ...
    public:
        ...
        Submat2D &Set(const component_type &m00,
                      const component_type &m01,
                      const component_type &m10,
                      const component_type &m11)
        {
            data[index_00] = m00;
            data[index_10] = m10;
            data[index_01] = m01;
        ...
        operator typename ConverterMatrix2D<type_struct,
                                            index_00,
                                            index_01,
                                            index_10,
                                            index_11>::matrix2D_type(void)
        {
            return (ConverterMatrix2D<type_struct,
                                      index_00,
                                      index_01,
                                      index_10,
                                      index_11>::Convert(data));
        }
        ...
        operator typename ConverterMatrix2D<type_struct,
                                            ...
                                            index_01,
                                            index_10,
                                            index_11>::const_matrix2D_type(void)
            const
        {
            return (ConverterMatrix2D<type_struct,
                                      index_00,
        ...
        template <typename type,
                  ...
                  int ind_11>
        Submat2D &operator=(
            const Submat2D<type, cnt, ind_00, ind_01, ind_10, ind_11> &value)
        {
    ...
    template <typename A_type_struct,
              ...
              int B_index_10,
              int B_index_11>
    inline bool operator==(const Submat2D<A_type_struct,
                                          A_count,
                                          A_index_00,
                                          A_index_01,
                                          A_index_10,
                                          A_index_11> &A,
                           const Submat2D<B_type_struct,
                                          B_count,
                                          B_index_00,
                                          B_index_01,
                                          B_index_10,
                                          B_index_11> &B)
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) &&
                (A.data[A_index_01] == B.data[B_index_01]) &&
                (A.data[A_index_10] == B.data[B_index_10]) &&
                (A.data[A_index_11] == B.data[B_index_11]));
    }
    ...
    struct ConverterMatrix3D
    {
        ...
        {
            return (matrix3D_type(data[index_00],
                                  data[index_01],
                                  data[index_02],
                                  data[index_10],
                                  data[index_11],
        ...
        {
            return (const_matrix3D_type(data[index_00],
                                        data[index_01],
                                        data[index_02],
                                        data[index_10],
                                        data[index_11],
    ...
    public:
        ...
        Submat3D &Set(const component_type &m00,
                      const component_type &m01,
                      const component_type &m02,
                      const component_type &m10,
                      const component_type &m11,
                      const component_type &m12,
                      const component_type &m20,
                      const component_type &m21,
                      const component_type &m22)
        {
            data[index_00] = m00;
            data[index_10] = m10;
            data[index_20] = m20;
        ...
        operator typename ConverterMatrix3D<type_struct,
                                            index_00,
                                            index_01,
                                            index_02,
                                            index_10,
                                            ...
                                            index_20,
                                            index_21,
                                            index_22>::matrix3D_type(void)
        {
            return (ConverterMatrix3D<type_struct,
                                      index_00,
                                      index_01,
                                      index_02,
                                      index_10,
        ...
        operator typename ConverterMatrix3D<type_struct,
                                            ...
                                            index_20,
                                            index_21,
                                            index_22>::const_matrix3D_type(void)
            const
        {
            return (ConverterMatrix3D<type_struct,
                                      index_00,
        ...
        template <typename type,
                  ...
                  int ind_21,
                  int ind_22>
        Submat3D &operator=(const Submat3D<type,
                                           cnt,
                                           ind_00,
                                           ind_01,
                                           ind_02,
    ...
    template <typename A_type_struct,
              ...
              int B_index_21,
              int B_index_22>
    inline bool operator==(const Submat3D<A_type_struct,
                                          A_count,
                                          A_index_00,
                                          A_index_01,
                                          A_index_02,
                                          ...
                                          B_index_22> &B)
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) &&
                (A.data[A_index_01] == B.data[B_index_01]) &&
                (A.data[A_index_02] == B.data[B_index_02]) &&
                (A.data[A_index_10] == B.data[B_index_10]) &&
                (A.data[A_index_11] == B.data[B_index_11]) &&
                (A.data[A_index_12] == B.data[B_index_12]) &&
                (A.data[A_index_20] == B.data[B_index_20]) &&
                (A.data[A_index_21] == B.data[B_index_21]) &&
                (A.data[A_index_22] == B.data[B_index_22]));
    }
    ...
    struct ConverterMatrix4D
    {
        ...
        {
            return (matrix4D_type(data[index_00],
                                  data[index_01],
                                  data[index_02],
                                  data[index_03],
                                  data[index_10],
        ...
        {
            return (const_matrix4D_type(data[index_00],
                                        data[index_01],
                                        data[index_02],
                                        data[index_03],
                                        data[index_10],
    ...
    template <typename type_struct>
    struct ConverterMatrix4D<type_struct,
                             0,
                             4,
                             8,
                             12,
    ...
    public:
        ...
        Submat4D &Set(const component_type &m00,
                      const component_type &m01,
                      const component_type &m02,
                      const component_type &m03,
                      const component_type &m10,
                      const component_type &m11,
                      const component_type &m12,
                      const component_type &m13,
                      const component_type &m20,
                      const component_type &m21,
                      const component_type &m22,
                      const component_type &m23,
                      const component_type &m30,
                      const component_type &m31,
                      const component_type &m32,
                      const component_type &m33)
        {
            data[index_00] = m00;
            data[index_10] = m10;
            data[index_20] = m20;
        ...
        operator typename ConverterMatrix4D<type_struct,
                                            index_00,
                                            index_01,
                                            index_02,
                                            index_03,
                                            ...
                                            index_31,
                                            index_32,
                                            index_33>::matrix4D_type(void)
        {
            return (ConverterMatrix4D<type_struct,
                                      index_00,
                                      index_01,
                                      index_02,
                                      index_03,
        ...
        operator typename ConverterMatrix4D<type_struct,
                                            ...
                                            index_31,
                                            index_32,
                                            index_33>::const_matrix4D_type(void)
            const
        {
            return (ConverterMatrix4D<type_struct,
                                      index_00,
        ...
        template <typename type,
                  ...
                  int ind_32,
                  int ind_33>
        Submat4D &operator=(const Submat4D<type,
                                           cnt,
                                           ind_00,
                                           ind_01,
                                           ind_02,
    ...
    template <typename A_type_struct,
              ...
              int B_index_32,
              int B_index_33>
    inline bool operator==(const Submat4D<A_type_struct,
                                          A_count,
                                          A_index_00,
                                          A_index_01,
                                          A_index_02,
                                          ...
                                          B_index_33> &B)
    {
        return ((A.data[A_index_00] == B.data[B_index_00]) &&
                (A.data[A_index_01] == B.data[B_index_01]) &&
                (A.data[A_index_02] == B.data[B_index_02]) &&
                (A.data[A_index_03] == B.data[B_index_03]) &&
                (A.data[A_index_10] == B.data[B_index_10]) &&
                (A.data[A_index_11] == B.data[B_index_11]) &&
                (A.data[A_index_12] == B.data[B_index_12]) &&
                (A.data[A_index_13] == B.data[B_index_13]) &&
                (A.data[A_index_20] == B.data[B_index_20]) &&
                (A.data[A_index_21] == B.data[B_index_21]) &&
                (A.data[A_index_22] == B.data[B_index_22]) &&
                (A.data[A_index_23] == B.data[B_index_23]) &&
                (A.data[A_index_30] == B.data[B_index_30]) &&
                (A.data[A_index_31] == B.data[B_index_31]) &&
                (A.data[A_index_32] == B.data[B_index_32]) &&
                (A.data[A_index_33] == B.data[B_index_33]));
    }
    ...
    template <typename type_struct> class Mat2D
    {
    public:
        typedef typename type_struct::component_type component_type;
    ...
    protected:
        ...
        Mat2D(const component_type &n00,
              const component_type &n01,
              const component_type &n10,
              const component_type &n11)
        {
    ...
    public:
        ...
        {
            return (
                reinterpret_cast<typename column_type_struct::vector2D_type &>(
                    matrix.data[j * 2]));
        }

        const typename column_type_struct::vector2D_type &
        operator[](machine j) const
        {
        ...
        template <typename type,
                  ...
                  int ind_11>
        Mat2D &
        operator=(const Submat2D<type, cnt, ind_00, ind_01, ind_10, ind_11> &m)
        {
            matrix = m;
            return (*this);
        }
    ...
    template <typename type_struct>
    inline bool operator==(const Mat2D<type_struct> &m1,
                           const Mat2D<type_struct> &m2)
    {
    ...
    template <typename type_struct> class Mat3D
    {
    public:
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::column_type_struct column_type_struct;
    ...
    protected:
        ...
        Mat3D(const component_type &n00,
              const component_type &n01,
              const component_type &n02,
              const component_type &n10,
              const component_type &n11,
              const component_type &n12,
              const component_type &n20,
              const component_type &n21,
              const component_type &n22)
        {
    ...
    public:
        ...
        {
            return (
                reinterpret_cast<typename column_type_struct::vector3D_type &>(
                    matrix.data[j * 3]));
        }

        const typename column_type_struct::vector3D_type &
        operator[](machine j) const
        {
            return (reinterpret_cast<
                    const typename column_type_struct::vector3D_type &>(
        ...
        template <typename type,
                  ...
                  int ind_21,
                  int ind_22>
        Mat3D &operator=(const Submat3D<type,
                                        cnt,
                                        ind_00,
                                        ind_01,
                                        ind_02,
    ...
    template <typename type_struct>
    inline bool operator==(const Mat3D<type_struct> &m1,
                           const Mat3D<type_struct> &m2)
    {
        return (m1.matrix == m2.matrix);
    }
    ...
    template <typename type_struct> class Mat4D
    {
    public:
        typedef typename type_struct::component_type component_type;
        typedef typename type_struct::column_type_struct column_type_struct;
        ...
        union
        {
            ...
            alignas(
                16) Subvec4D<column_type_struct, false, 16, 0, 1, 2, 3> col0;
            alignas(
                16) Subvec4D<column_type_struct, false, 16, 4, 5, 6, 7> col1;
            alignas(
                16) Subvec4D<column_type_struct, false, 16, 8, 9, 10, 11> col2;
            alignas(16)
                Subvec4D<column_type_struct, false, 16, 12, 13, 14, 15> col3;
            ...
            alignas(16)
                Submat3D<type_struct, 16, 0, 4, 8, 1, 5, 9, 2, 6, 10> matrix3D;
            alignas(16) Submat3D<type_struct,
                                 16,
                                 0,
                                 1,
                                 2,
                                 ...
                                 9,
                                 10> transpose3D;
            alignas(16) Submat4D<type_struct,
                                 16,
                                 0,
                                 4,
                                 8,
    ...
    protected:
        ...
        Mat4D(const component_type &n00,
              const component_type &n01,
              const component_type &n02,
              const component_type &n03,
              const component_type &n10,
              const component_type &n11,
              const component_type &n12,
              const component_type &n13,
              const component_type &n20,
              const component_type &n21,
              const component_type &n22,
              const component_type &n23,
              const component_type &n30,
              const component_type &n31,
              const component_type &n32,
              const component_type &n33)
        {
            matrix.Set(n00,
                       n01,
                       n02,
    ...
    public:
        ...
        {
            return (
                reinterpret_cast<typename column_type_struct::vector4D_type &>(
                    matrix.data[j * 4]));
        }

        const typename column_type_struct::vector4D_type &
        operator[](machine j) const
        {
            return (reinterpret_cast<
                    const typename column_type_struct::vector4D_type &>(
        ...
        template <typename type,
                  ...
                  int ind_32,
                  int ind_33>
        Mat4D &operator=(const Submat4D<type,
                                        cnt,
                                        ind_00,
                                        ind_01,
                                        ind_02,
    ...
    template <typename type_struct>
    inline bool operator==(const Mat4D<type_struct> &m1,
                           const Mat4D<type_struct> &m2)
    {
        return (m1.matrix == m2.matrix);
    }
    ...
    template <typename m_type_struct,
              int m_count,
              int m_index_00,
              int m_index_01,
              int m_index_10,
              int m_index_11,
              typename v_type_struct,
              int v_count,
              int v_index_x,
              int v_index_y>
    inline typename v_type_struct::vector2D_type
    operator*(const Submat2D<m_type_struct,
                             m_count,
                             m_index_00,
                             m_index_01,
                             m_index_10,
    ...
    {
        return (typename v_type_struct::vector2D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_01] * v.data[v_index_y],
            m.data[m_index_10] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y]));
    }

    template <typename v_type_struct,
              int v_count,
              int v_index_x,
              int v_index_y,
              typename m_type_struct,
              int m_count,
              int m_index_00,
              int m_index_01,
              int m_index_10,
              int m_index_11>
    inline typename v_type_struct::vector2D_type
    operator*(const Subvec2D<v_type_struct, v_count, v_index_x, v_index_y> &v,
              const Submat2D<m_type_struct,
                             m_count,
                             m_index_00,
                             m_index_01,
                             m_index_10,
                             m_index_11> &m)
    {
        return (typename v_type_struct::vector2D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_10] * v.data[v_index_y],
            m.data[m_index_01] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y]));
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_10,
              int B_index_11>
    typename A_type_struct::matrix2D_type
    operator*(const Submat2D<A_type_struct,
                             A_count,
                             A_index_00,
                             A_index_01,
                             A_index_10,
    ...
    template <typename m_type_struct,
              ...
              int v_index_y,
              int v_index_z>
    inline typename v_type_struct::vector3D_type
    operator*(const Submat3D<m_type_struct,
                             m_count,
                             m_index_00,
                             m_index_01,
                             m_index_02,
              ...
              const Subvec3D<v_type_struct,
                             ...
                             v_index_z> &v)
    {
        return (typename v_type_struct::vector3D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_01] * v.data[v_index_y] +
                m.data[m_index_02] * v.data[v_index_z],
            m.data[m_index_10] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y] +
                m.data[m_index_12] * v.data[v_index_z],
            m.data[m_index_20] * v.data[v_index_x] +
                m.data[m_index_21] * v.data[v_index_y] +
                m.data[m_index_22] * v.data[v_index_z]));
    }
    ...
    template <typename v_type_struct,
              ...
              int m_index_22>
    inline typename v_type_struct::vector3D_type
    operator*(const Subvec3D<v_type_struct,
                             true,
                             v_count,
                             v_index_x,
                             v_index_y,
                             v_index_z> &v,
              const Submat3D<m_type_struct,
                             m_count,
                             m_index_00,
                             m_index_01,
                             m_index_02,
                             ...
                             m_index_22> &m)
    {
        return (typename v_type_struct::vector3D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_10] * v.data[v_index_y] +
                m.data[m_index_20] * v.data[v_index_z],
            m.data[m_index_01] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y] +
                m.data[m_index_21] * v.data[v_index_z],
            m.data[m_index_02] * v.data[v_index_x] +
                m.data[m_index_12] * v.data[v_index_y] +
                m.data[m_index_22] * v.data[v_index_z]));
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_21,
              int B_index_22>
    typename A_type_struct::matrix3D_type
    operator*(const Submat3D<A_type_struct,
                             A_count,
                             A_index_00,
                             A_index_01,
                             A_index_02,
    ...
    template <typename m_type_struct,
              ...
              int v_index_z,
              int v_index_w>
    inline typename v_type_struct::vector4D_type
    operator*(const Submat4D<m_type_struct,
                             m_count,
                             m_index_00,
                             m_index_01,
                             m_index_02,
              ...
              const Subvec4D<v_type_struct,
                             ...
                             v_index_w> &v)
    {
        return (typename v_type_struct::vector4D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_01] * v.data[v_index_y] +
                m.data[m_index_02] * v.data[v_index_z] +
                m.data[m_index_03] * v.data[v_index_w],
            m.data[m_index_10] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y] +
                m.data[m_index_12] * v.data[v_index_z] +
                m.data[m_index_13] * v.data[v_index_w],
            m.data[m_index_20] * v.data[v_index_x] +
                m.data[m_index_21] * v.data[v_index_y] +
                m.data[m_index_22] * v.data[v_index_z] +
                m.data[m_index_23] * v.data[v_index_w],
            m.data[m_index_30] * v.data[v_index_x] +
                m.data[m_index_31] * v.data[v_index_y] +
                m.data[m_index_32] * v.data[v_index_z] +
                m.data[m_index_33] * v.data[v_index_w]));
    }
    ...
    template <typename v_type_struct,
              ...
              int m_index_33>
    inline typename v_type_struct::vector4D_type
    operator*(const Subvec4D<v_type_struct,
                             true,
                             v_count,
                             v_index_x,
                             v_index_y,
                             ...
                             m_index_33> &m)
    {
        return (typename v_type_struct::vector4D_type(
            m.data[m_index_00] * v.data[v_index_x] +
                m.data[m_index_10] * v.data[v_index_y] +
                m.data[m_index_20] * v.data[v_index_z] +
                m.data[m_index_30] * v.data[v_index_w],
            m.data[m_index_01] * v.data[v_index_x] +
                m.data[m_index_11] * v.data[v_index_y] +
                m.data[m_index_21] * v.data[v_index_z] +
                m.data[m_index_31] * v.data[v_index_w],
            m.data[m_index_02] * v.data[v_index_x] +
                m.data[m_index_12] * v.data[v_index_y] +
                m.data[m_index_22] * v.data[v_index_z] +
                m.data[m_index_32] * v.data[v_index_w],
            m.data[m_index_03] * v.data[v_index_x] +
                m.data[m_index_13] * v.data[v_index_y] +
                m.data[m_index_23] * v.data[v_index_z] +
                m.data[m_index_33] * v.data[v_index_w]));
    }
    ...
    template <typename A_type_struct,
              ...
              int B_index_32,
              int B_index_33>
    typename A_type_struct::matrix4D_type
    operator*(const Submat4D<A_type_struct,
                             A_count,
                             A_index_00,
                             A_index_01,
                             A_index_02,
